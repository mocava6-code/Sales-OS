...
export function KoriPulseHeader({ firstName, briefing, now }: { firstName: string; briefing: KoriBriefing; now: Date }) {
  return (
    <header className="pb-2 pt-1">
      ...
      <p className="mt-1 text-sm leading-relaxed text-neutral-500">{buildPulseSummary(briefing)}</p>
    </header>
  );
}
